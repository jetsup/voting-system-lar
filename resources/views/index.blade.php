...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/font-awesome/all.css') }}">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-t-190 p-b-30">
                <form class="login100-form validate-form" method="POST" action="/signin" onsubmit="validateCaptcha()">
                    @csrf
                ...
                <div class="error">
                    <div class="text-center w-full">
                        <a class="txt1" href="/forgotpassword">
                            Forgot Password?
                        </a>
                    </div>
                </div>
