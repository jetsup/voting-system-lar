    ...
    <body>
        <section id="main-content" style=" margin-right:110px;">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-file-text-o"></i>View Report</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i>Home</li>
                            <li><i class="icon_document_alt"></i>Report</li>
                            <li><i class="fa fa-file-text-o"></i>View Report</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" action="view_report" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Election ID</label>
                                        <div class="col-sm-10">
                                            <select name="e_id" class="form-control" style="width:80%;">
                                                {{-- {% for i in elections %}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="states" name="states" class="form-control"
                                                onchange="st(this.id,'constituency1')" style="width:80%;">
                                                <option value="" selected="selected">State/UT</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="constituency1" class="form-control" id="constituency1"
                                                onchange="st2(this.id,'Constituency2')" style="width:80%;">
