            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="{% url 'adminhome' %}">Home</a></li>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <div class="panel-body">
                                <form class="form-horizontal " action="view_candidate" id="CandidateCustomFilter"
                                    method="POST">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="states" name="states" class="form-control"
                                                onchange="st(this.id,'constituency1')" style="width:80%;" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="constituency1" class="form-control" id="constituency1"
                                                onchange="st2(this.id,'Constituency2')" style="width:80%;" required>
                                                <option value="">Select Constituency Type</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="constituency2" class="form-control" id="Constituency2"
                                ...
                                <div class="panel-body" style="background-color: #444d50;">
                                    <div class="col-lg-2 col-sm-2 mt-4">
                                        <div class="follow-ava">
                                            <a><img src="{{ candidate . candidate_image . url }}" alt=""
                                                    class="het-90"></a>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-4 follow-info">
                                        ...
                                        <p><strong>Constituency Type:</strong> {{ candidate . constituency }}</p>
                                        <p><strong>Constituency:</strong> {{ constituency }}</p>
                                        <p><strong>Party :</strong> {{ candidate . candidate_party }}</p>
