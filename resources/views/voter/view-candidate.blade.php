        ...
        <div class="col-lg-12">
          <section class="panel">
            <div class="panel-body">
              <form class="form-horizontal" action="vview_candidate" id="CandidateCustomFilter" method="POST">
                @csrf
                <div class="form-group">
                  <label class="col-sm-2 control-label">Province</label>
                  <div class="col-sm-10">
                    <select id="province" name="province" class="form-control" style="width:80%;height:34px;" required
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="county" class="form-control" id="county" onchange="getConstituencies(this.value)"
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="constituency" class="form-control" id="constituency" style="width:80%;height:34px;">
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    <button class="btn btn-primary" name="view_candidate" type="submit">Filter</button>
                  </div>
                </div>
              </form>
            </div>
